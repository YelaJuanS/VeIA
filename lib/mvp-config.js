...
export const SCENARIO = {
  ...
  // Pregunta que acota dónde está la falla: distinguir "solo mi casa" de "toda
  // la cuadra" es lo que separa un problema interno del domiciliario de una
  // falla en la red, y orienta a qué punto debe ir la brigada.
  scopeQuestion: "¿Qué ves a tu alrededor?",
  scopeHint: "Nos ayuda a ubicar el punto exacto de la falla.",
  faultScopes: [
    { value: "casa", icon: "🏠", label: "Solo mi casa" },
    { value: "cuadra", icon: "🏘️", label: "Toda la cuadra" },
    { value: "barrio", icon: "🌆", label: "Varias cuadras" },
    { value: "poste", icon: "⚡", label: "Un poste o cable dañado" },
  ],
