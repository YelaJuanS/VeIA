...
//
// APAGADO A PROPÓSITO durante el test de usabilidad de S7. El navegador
// muestra su propio diálogo de permisos, que no se puede estilizar ni evitar:
// es un evento de usabilidad enorme, ajeno al producto, que se comería la
// atención del participante y contaminaría el time-to-value justo en el paso
// previo al momento de valor. Además, si lo deniegan hace falta el mismo
// camino alternativo que ya existe, así que el test no aprende nada nuevo.
//
// Ponlo en true cuando quieras probar la captura real (fuera del test, o en
// una ronda posterior enfocada precisamente en el permiso).
